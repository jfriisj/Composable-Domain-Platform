workspace "Composable Domain Platform" "Authoritative architecture model for the Composable Domain Platform." {
    ...
    model {
        ...
        eventApi = element "Event API" "Gradle project" "Public application-level contract for defining, updating, and retrieving Event state with explicit execution context." "Current,Event Module,API"
        ...
        eventRegistrationComposition = element "Event-Registration Composition" "Gradle project" "Event-specific workflow that verifies Event existence and publication eligibility, translates Event workflow identities into Registration references, and exposes organizer Event-registration views through public APIs." "Current,Composition"
        ...
        eventManagementComposition -> eventApi "Defines, updates, publishes, and retrieves Event state"
        ...
        eventRegistrationComposition -> eventApi "Resolves Event existence, publication eligibility, and organizer ownership"
