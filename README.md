...
- **Developer environment:** usage and interactive-shell reference in [`dev/README.md`](dev/README.md); executable entrypoint [`dev/dev.sh`](dev/dev.sh); accepted technology constraints are recorded in [`docs/tech-stack.md`](docs/tech-stack.md).
